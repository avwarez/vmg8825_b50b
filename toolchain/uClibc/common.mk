...
ifeq ($(call qstrip,$(CONFIG_CUSTOM_SDK_PREFIX)),EN7528SDK)
SPECIAL_SOC=en7528
endif
...
ifeq ("_$(CONFIG_mipsel)_$(CONFIG_TARGET_en75xx)_$(CONFIG_UCLIBC_VERSION_0_9_33)_","_y_y_y_")
CPU_CFLAGS += \
	-msoft-float \
	-march=mips32r2 \
	-mtune=mips32r2 \
...
ifneq ("_$(CONFIG_mipsel)_$(CONFIG_TARGET_en75xx)_$(CONFIG_UCLIBC_VERSION_0_9_33)_","_y_y_y_")
CPU_CFLAGS += \
	$(TARGET_CFLAGS)
endif
endif
