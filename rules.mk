...
export CONFIG_EXTERNAL_TOOLCHAIN
ifeq ("$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN)_$(CONFIG_EXTERNAL_TOOLCHAIN)","y_")
...
else ifeq ("$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN)_$(CONFIG_EXTERNAL_TOOLCHAIN)","y_y")
  KERNEL_TOOLCHAIN_DIR:=$(call qstrip,$(CONFIG_KERNEL_TOOLCHAIN_ROOT))
  else
...
export TOOLCHAIN_INC_DIRS
export TOOLCHAIN_LIB_DIRS
